(
    function (e) {
        e.extend(e.fn, {
            swapClass:
                function (e, t) {
                    var n = this.filter("." + e); this.filter("." + t).removeClass(t).addClass(e);
            ...
            heightToggle: function (e, t) {
                e ? this.animate(
                    { height: "toggle" }, e, t) : this.each(function () {
            ...
            applyClasses: function (n, r) {
                this.filter(":has(>ul):not(:has(>a))").find(">span").click(
                    function (t) { r.apply(e(this).next()) }).add(e("a", this)).hoverClass();
                if (!n.prerendered) {
                    ...
                    this.prepend('<div class="' + t.hitarea + '"/>').find("div." + t.hitarea).each(
                        function () {
                            var t = ""; e.each(e(this).parent().attr("class").split(" "), function () {
                                t += this + "-hitarea "
                            });
                            e(this).addClass(t)
                        })
            ...
            treeview: function (n) {
                function i(n, r) {
                    function i(r) {
                        return function () {
                            s.apply(e("div." + t.hitarea, n).filter(
                                function () { return r ? e(this).parent("." + r).length : true }));
                            return false
                        }
                    }
