function AddMenuSubMenu(e) {
    ...
    if (HasTab == 0 || e == "Menu") {
        ...
        $("#IsSelected").val(""); $("span").filter(
            function () { return this.className }).removeClass("SelectedLi")
    }
}
function EditMenu() {
    $("#ParentMenuName").val("");
    ...
    if (e == "1") {
        $("#TypeOpr").val("edit");
        $.ajax({
            url: "/Admin/ResearchDevelopment/GetInfoWorkGroup",
...
function UpMenu() {
    ...
    var e = $("#IsSelected").val(); if (e == "1") {
        var t = $("span[class='SelectedLi']").parent(); var n = $("span[class='SelectedLi']").parent().next();
        var r = n.val(); var i = t.val(); t.before(n); if (r != null && i != null) { ClassSettingUpDown(n, t); ChangePriority(i, r) }
    }
    else return ShowPopupAlert("#PopUp-Content-Alert")
}
...
function ChangePriority(e, t) {
    $.ajax({
        url: "/Admin/ResearchDevelopment/UpDownResearchDevelopmentGroup",
        data: "{CurrentId: " + parseInt(e) + ", PrevId: " + parseInt(t) + " }", dataType: "json",
        contentType: "application/json; charset=utf-8", type: "POST", success: function (e) { }
    })
}
function WhichOprForPriority() {
    if ($("#ParentMenuName").val().length == 0) {
        ...
        var e = $("#HiddenMenuId").val(); var t = $("#TypeOpr").val(); if (t == "Menu") { e = null }
        if (t != "edit") {
            $.ajax({
                url: "/Admin/ResearchDevelopment/GetPriority",
                data: "{ 'id': '" + e + "'}", dataType: "json", contentType: "application/json; charset=utf-8",
                type: "POST", async: false, success: function (e) {
