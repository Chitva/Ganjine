...
namespace WebUI.Areas.Admin.Controllers
{
    ...
    {
        public string root = System.Web.Hosting.HostingEnvironment.MapPath("~/Upload");
        //public FileUploadController(int adminId)
        //{
        //    root += root + adminId + "/";
        //}
        //int userId = 0;
        ...
        private string GetFileName(MultipartFormDataStreamProvider provider)
        {
            ...
            return !String.IsNullOrEmpty(filename) ? filename :
                provider.FileData[0].Headers.ContentDisposition.FileName.Trim('\"');
        }
        ...
        {
            targetName = Path.GetFileName(targetName); 
