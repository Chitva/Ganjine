...
Outlayer.prototype.prepended = function( elems ) {
  ...
  this._resetLayout();
  this._manageStamps();
  // layout new Staff without transition
  this.layoutItems( items, true );
  this.reveal( items );
...
function masonryDefinition( Outlayer, getSize ) {
  ...
  Masonry.prototype._getItemLayoutPosition = function( item ) {
    ...
    //    x1 = (this.element.outerWidth(true) - $brick.outerWidth(true)) - (this[this.options.layoutMode].columnWidth * shortCol);
    //} else {
    //    x1 = this.masonry.columnWidth * shortCol;
    //}
    //y1 = minimumY;
    //  var position = {
    //    x:x1,
