    ...
    public static class BackloadConfig
    {
        ...
        private static void registerBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new StyleBundle("~/Content/Admin").
                Include("~/Content/Admin/AdminDesign.css", "~/Content/Admin/Menus.css",
                "~/Content/Admin/RightMenu.css", "~/Content/Admin/admin.css", "~/Content/Admin/validation.css"));

            bundles.Add(new StyleBundle("~/Content/Menu").
               Include("~/Content/Admin/VerticalMenu/helper.css",
               "~/Content/Admin/VerticalMenu/dropdown.vertical.rtl.css", "~/Content/Admin/VerticalMenu/default.css"));
