...
{
    public class FileUploadWorkExperienceController : Controller
    {
        ...
        void handler_GetFilesRequestStarted(object sender, Eventing.Args.GetFilesRequestEventArgs e)
        {
            ...
            if (Folder != null && Folder.Length > 0)
                e.Param.SearchPath = Server.MapPath("~/Files/Gallery/" + Folder);
            else
                e.Param.SearchPath = Server.MapPath("~/Files/Gallery");
        ...
        async Task handler_StoreFileRequestStartedAsync(object sender, Eventing.Args.StoreFileRequestEventArgs e)
        {
            ...
            if (e.Param.FileStatusItem.StorageInfo.FilePath != Server.MapPath("~/Files/Gallery/" + FolderId + "/") + e.Param.FileStatusItem.FileName)
            {
                ExtFile = "ErrorPath";
            }
            ...
            if (ExtFile == "")
            {
                ...
                WorkExperienceGallery Item = new WorkExperienceGallery();
                Item.Image = e.Param.FileStatusItem.FileName;
                Item.WorkExperiencesId = FolderId;
                EFDbContext.WorkExperienceGalleries.Add(Item);
        ...
        string ChangeUnKnownCharacters(string inputstring)
        {
        ...
        void handler_DeleteFilesRequestStarted(object sender, Eventing.Args.DeleteFilesRequestEventArgs e)
        {
            ...
            WorkExperienceGallery WorkExperienceGallery = EFDbContext.WorkExperienceGalleries.FirstOrDefault(x => x.WorkExperiencesId == NewsId && x.Image == FileName);
            EFDbContext.WorkExperienceGalleries.Remove(WorkExperienceGallery);
            EFDbContext.SaveChanges();
