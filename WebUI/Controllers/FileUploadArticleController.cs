...
{
    public class FileUploadArticleController : Controller
    {
        ...
        // int a=  e.Context.Request.Files.Count;
            ...
            e.Param.SearchPath = Server.MapPath("~/Files/ArticleGallery/" + Folder);
            else
                e.Param.SearchPath = Server.MapPath("~/Files/ArticleGallery");
        ...
        async Task handler_StoreFileRequestStartedAsync(object sender, Eventing.Args.StoreFileRequestEventArgs e)
        {
            ...
            if (e.Param.FileStatusItem.StorageInfo.FilePath != Server.MapPath("~/Files/ArticleGallery/" + FolderId + "/") 
            ...
            if (ExtFile == "")
            {
                ...
                ArticleGallery Item = new ArticleGallery();
                Item.Image = e.Param.FileStatusItem.FileName;
                Item.ArticleId = FolderId;
                EFDbContext.ArticleGalleries.Add(Item);
        ...
        void handler_DeleteFilesRequestStarted(object sender, Eventing.Args.DeleteFilesRequestEventArgs e)
        {
         //   e.Context.PipelineControl.ExecutePipeline = false;
            ...
            ArticleGallery NewsGallery = EFDbContext.ArticleGalleries.FirstOrDefault(x => x.ArticleId == NewsId && x.Image == FileName);
            EFDbContext.ArticleGalleries.Remove(NewsGallery);
            EFDbContext.SaveChanges();
