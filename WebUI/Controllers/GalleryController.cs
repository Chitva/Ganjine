...
namespace WebUI.Controllers
{
    public class GalleryController : Controller
    {
        ...
        public GalleryController(
            IUnitOfWork uow, IFooterRepository FooterRepository, IServiceRepository ServiceRepository,
        ...
        public ActionResult Index(int id,string Title)
        {
            InitializeData();
            ViewBag.catids = id;
            var WorkExperienceGroup =_RWorkExperience.WorkExperienceGroups.Where(x => x.LanguageId == 1).ToList();
